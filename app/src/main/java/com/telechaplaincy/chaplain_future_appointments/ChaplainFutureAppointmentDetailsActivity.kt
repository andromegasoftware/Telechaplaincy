...
class ChaplainFutureAppointmentDetailsActivity : AppCompatActivity() {
    ...
    private fun sendMailToChaplain() {
        ...
        mailSendClass.sendMailToChaplain(
            getString(R.string.chaplain_appointment_cancel_mail_title_for_chaplain),
            body, chaplainMail
        )
    }
    ...
    private fun sendMailToPatient() {
        ...
        mailSendClass.sendMailToChaplain(
            getString(R.string.chaplain_appointment_cancel_mail_title),
            body, patientMail
        )
    }
                    ...
                    if (result != null) {
                        if (result.patientProfileImageLink != null){
                            ...
                            Picasso.get().load(patientProfileImageLink)
                                ...
                                .into(future_appointment_imageView_patient_image)
                        }
