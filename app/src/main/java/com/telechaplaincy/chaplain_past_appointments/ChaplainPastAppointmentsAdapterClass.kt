...
class ChaplainPastAppointmentsAdapterClass  (var chaplainList: List<PatientFutureAppointmentsModelClass>, private val clickListener: (PatientFutureAppointmentsModelClass) -> Unit): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
