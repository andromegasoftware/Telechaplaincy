...
import kotlinx.android.synthetic.main.activity_all_chaplains_wait_payment.*

class AllChaplainsWaitPaymentActivity : AppCompatActivity() {
    ...
    private lateinit var allChaplainsListedAdapterClass: AllChaplainsWaitPaymentAdapterClass
    private var queryWord: String = ""
    private var queryChaplainsArrayList = ArrayList<ChaplainUserProfile>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_all_chaplains_wait_payment)
        ...
        allChaplainsListedAdapterClass =
            AllChaplainsWaitPaymentAdapterClass(allChaplainsListArray) { chaplainListModelClassItem: ChaplainUserProfile ->
        ...
        all_chaplains_wait_payment_recyclerView.layoutManager = chaplainListsLayoutManager
        all_chaplains_wait_payment_recyclerView.adapter = allChaplainsListedAdapterClass
    }
    ...
    private fun allChaplainsListMethod() {
        val queryHumanistChaplain =
            queryRef.whereEqualTo("isPaymentWait", true)
                .get()
        ...
        val searchView = findViewById<SearchView>(R.id.searchView_all_chaplains_wait_payment)
