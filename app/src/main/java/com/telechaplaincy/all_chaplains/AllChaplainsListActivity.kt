package com.telechaplaincy.all_chaplains
...
import kotlinx.android.synthetic.main.activity_all_chaplains_list.*

class AllChaplainsListActivity : AppCompatActivity() {
    ...
    private lateinit var allChaplainsListedAdapterClass: AllChaplainsListedAdapterClass
    private var queryWord: String = ""
    private var queryChaplainsArrayList = ArrayList<ChaplainUserProfile>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_all_chaplains_list)
        ...
        allChaplainsListedAdapterClass =
            AllChaplainsListedAdapterClass(allChaplainsListArray) { chaplainListModelClassItem: ChaplainUserProfile ->
        ...
        allChaplainsRecyclerView.layoutManager = chaplainListsLayoutManager
        allChaplainsRecyclerView.adapter = allChaplainsListedAdapterClass
    }
    ...
    private fun allChaplainsListMethod() {
        val queryHumanistChaplain =
            queryRef.whereEqualTo("accountStatus", "2")
                .get()
        ...
        val searchView = findViewById<SearchView>(R.id.searchView_All_Chaplains)
